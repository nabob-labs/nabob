...
use nabob_framework::{ReleaseOptions, ReleaseTarget};
use clap::Parser;

#[derive(Parser)]
#[clap(name = "nabob-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an Nabob framework release for the specified target.
