...
use crate::{
    ...
    zip_metadata, zip_metadata_str, RuntimeModuleMetadataV1, NABOB_METADATA_KEY,
    NABOB_METADATA_KEY_V1, METADATA_V1_MIN_FILE_FORMAT_VERSION,
};
use anyhow::bail;
use nabob_types::{account_address::AccountAddress, transaction::EntryABI};
use clap::Parser;
...
pub const NABOB_PACKAGES: [&str; 5] = [
    "NabobFramework",
    "MoveStdlib",
    "NabobStdlib",
    "NabobToken",
                    ...
                    if !module_metadata.is_empty() {
                            ...
                            >= METADATA_V1_MIN_FILE_FORMAT_VERSION
                        {
                            ...
                            named_module.module.metadata.push(Metadata {
                                key: NABOB_METADATA_KEY_V1.to_vec(),
