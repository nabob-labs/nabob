...
module nabob_framework::fungible_asset {
    use nabob_framework::aggregator_v2::{Self, Aggregator};
    use nabob_framework::create_signer;
    use nabob_framework::event;
    use nabob_framework::function_info::{Self, FunctionInfo};
    use nabob_framework::object::{Self, Object, ConstructorRef, DeleteRef, ExtendRef};
    ...
    friend nabob_framework::primary_fungible_store;
    ...
    fun has_supply_dispatch_function(metadata_addr: address): bool {
        // Short circuit on BOB for better perf
        if (metadata_addr != @nabob_fungible_asset) {
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x50003, location = nabob_framework::object)]
    ...
    #[test(fx = @nabob_framework, creator = @0xcafe)]
    ...
    fun test_e2e_withdraw_limit(
        ...
        let nabob_framework = account::create_signer_for_test(@0x1);
