...
use nabob_framework::ReleaseTarget;
...
fn main() -> Result<()> {
    ...
    if std::env::var("SKIP_FRAMEWORK_BUILD").is_err() {
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("nabob-token").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("nabob-token").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir
        ...
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("nabob-framework").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("nabob-framework").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("nabob-stdlib").join("sources").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
            prev_dir.join("nabob-stdlib").join("Move.toml").display()
        );
        println!(
            "cargo:rerun-if-changed={}",
