...
pub use crate::{
    nabob_framework_sdk_builder::*, nabob_token_objects_sdk_builder as nabob_token_objects_stdlib,
    nabob_token_sdk_builder as nabob_token_stdlib,
};
use nabob_framework::{BuildOptions, BuiltPackage};
use nabob_package_builder::PackageBuilder;
use nabob_types::{
...
pub fn nabob_coin_transfer(to: AccountAddress, amount: u64) -> TransactionPayload {
    coin_transfer(NabobCoinType::type_tag(), to, amount)
}
