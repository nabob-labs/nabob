...
Defines feature flags for Nabob. Those are used in Nabob specific implementations of features in
the Move stdlib, the Nabob stdlib, and the Nabob framework.
...
-  [Function `get_nabob_stdlib_chain_id_feature`](#0x1_features_get_nabob_stdlib_chain_id_feature)
-  [Function `nabob_stdlib_chain_id_enabled`](#0x1_features_nabob_stdlib_chain_id_enabled)
...
Deprecated by <code>nabob_framework::jwk_consensus_config::JWKConsensusConfig</code>.
...
Whether nabob_framwork enables the behavior of module event migration.
...
Whether the new <code>nabob_stdlib::multi_ed25519::public_key_validate_internal_v2()</code> native is enabled.
...
<a id="0x1_features_NABOB_STD_CHAIN_ID_NATIVES"></a>

Whether the new <code>nabob_stdlib::type_info::chain_id()</code> native for fetching the chain ID is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_NABOB_STD_CHAIN_ID_NATIVES">NABOB_STD_CHAIN_ID_NATIVES</a>: u64 = 4;
</code></pre>



<a id="0x1_features_NABOB_UNIQUE_IDENTIFIERS"></a>

Whether enable MOVE functions to call create_auid method to create AUIDs.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_NABOB_UNIQUE_IDENTIFIERS">NABOB_UNIQUE_IDENTIFIERS</a>: u64 = 23;
</code></pre>
...
Whether enable paritial governance voting on nabob_governance.
Lifetime: transient
...
Deprecated by <code>nabob_framework::randomness_config::RandomnessConfig</code>.
...
<a id="0x1_features_get_nabob_stdlib_chain_id_feature"></a>

## Function `get_nabob_stdlib_chain_id_feature`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_nabob_stdlib_chain_id_feature">get_nabob_stdlib_chain_id_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_nabob_stdlib_chain_id_feature">get_nabob_stdlib_chain_id_feature</a>(): u64 { <a href="features.md#0x1_features_NABOB_STD_CHAIN_ID_NATIVES">NABOB_STD_CHAIN_ID_NATIVES</a> }
</code></pre>
...
<a id="0x1_features_nabob_stdlib_chain_id_enabled"></a>

## Function `nabob_stdlib_chain_id_enabled`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_nabob_stdlib_chain_id_enabled">nabob_stdlib_chain_id_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_nabob_stdlib_chain_id_enabled">nabob_stdlib_chain_id_enabled</a>(): bool <b>acquires</b> <a href="features.md#0x1_features_Features">Features</a> {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_NABOB_STD_CHAIN_ID_NATIVES">NABOB_STD_CHAIN_ID_NATIVES</a>)
}
</code></pre>
