...
<dl>
<dt>
<code>fees_table: <a href="../../nabob-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<b>address</b>, <a href="coin.md#0x1_coin_Coin">coin::Coin</a>&lt;<a href="nabob_coin.md#0x1_nabob_coin_NabobCoin">nabob_coin::NabobCoin</a>&gt;&gt;</code>
</dt>
<dd>
...
<pre><code>inline <b>fun</b> <a href="stake.md#0x1_stake_check_stake_permission">check_stake_permission</a>(s: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>assert</b>!(
        ...
        <a href="../../move-stdlib/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="stake.md#0x1_stake_ENO_STAKE_PERMISSION">ENO_STAKE_PERMISSION</a>),
    );
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_store_nabob_coin_mint_cap">store_nabob_coin_mint_cap</a>(nabob_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, mint_cap: MintCapability&lt;NabobCoin&gt;) {
    <a href="system_addresses.md#0x1_system_addresses_assert_nabob_framework">system_addresses::assert_nabob_framework</a>(nabob_framework);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_owner">initialize_stake_owner</a>(
    ...
    <b>let</b> account_address = <a href="permissioned_signer.md#0x1_permissioned_signer_address_of">permissioned_signer::address_of</a>(owner);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_initialize_validator">initialize_validator</a>(
    ...
    <b>let</b> pubkey_from_pop = &<a href="../../nabob-stdlib/doc/bls12381.md#0x1_bls12381_public_key_from_bytes_with_pop">bls12381::public_key_from_bytes_with_pop</a>(
        consensus_pubkey,
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_rotate_consensus_key">rotate_consensus_key</a>(
    ...
    <b>let</b> stake_pool = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address);
    <b>assert</b>!(<a href="permissioned_signer.md#0x1_permissioned_signer_address_of">permissioned_signer::address_of</a>(operator) == stake_pool.operator_address, <a href="../../move-stdlib/doc/error.md#0x1_error_unauthenticated">error::unauthenticated</a>(<a href="stake.md#0x1_stake_ENOT_OPERATOR">ENOT_OPERATOR</a>));
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_update_performance_statistics">update_performance_statistics</a>(
    ...
    <b>if</b> (<a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(&proposer_index)) {
        ...
        // Here, and in all other <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>, skip <a href="../../nabob-stdlib/doc/any.md#0x1_any">any</a> validator indices that are out of bounds,
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_configure_allowed_validators">configure_allowed_validators</a>(nabob_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_configure_allowed_validators">configure_allowed_validators</a>(
    ...
    <b>let</b> nabob_framework_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(nabob_framework);
    <a href="system_addresses.md#0x1_system_addresses_assert_nabob_framework">system_addresses::assert_nabob_framework</a>(nabob_framework);
...
<b>let</b> nabob_addr = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(nabob_framework);
...
<b>let</b> pubkey_from_pop = <a href="../../nabob-stdlib/doc/bls12381.md#0x1_bls12381_spec_public_key_from_bytes_with_pop">bls12381::spec_public_key_from_bytes_with_pop</a>(
    consensus_pubkey,
    proof_of_possession_from_bytes(proof_of_possession)
);
...
<b>aborts_if</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>&gt;(@nabob_framework) && !<a href="../../move-stdlib/doc/vector.md#0x1_vector_spec_contains">vector::spec_contains</a>(allowed.accounts, addr);
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_ResourceRequirement">ResourceRequirement</a> {
    ...
    <b>requires</b> <b>exists</b>&lt;StakingRewardsConfig&gt;(@nabob_framework) || !<a href="../../move-stdlib/doc/features.md#0x1_features_spec_periodical_reward_rate_decrease_enabled">features::spec_periodical_reward_rate_decrease_enabled</a>();
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_DistributeRewardsAbortsIf">DistributeRewardsAbortsIf</a> {
    ...
    <b>let</b> addr = <a href="../../nabob-stdlib/doc/type_info.md#0x1_type_info_type_of">type_info::type_of</a>&lt;NabobCoin&gt;().account_address;
...
<pre><code><b>let</b> nabob_framework_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(nabob_framework);
