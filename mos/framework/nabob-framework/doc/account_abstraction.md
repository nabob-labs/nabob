...
<a id="0x1_account_abstraction_DomainRegisterValue"></a>

## Enum `DomainRegisterValue`



<pre><code>enum <a href="account_abstraction.md#0x1_account_abstraction_DomainRegisterValue">DomainRegisterValue</a> <b>has</b> store
</code></pre>
...
<a id="0x1_account_abstraction_derive_domain_account_address_view"></a>

## Function `derive_domain_account_address_view`

Return the account address corresponding to the given <code>account_identity</code>,
for the domain account abstraction defined by the given function.


<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_derive_domain_account_address_view">derive_domain_account_address_view</a>(module_address: <b>address</b>, module_name: <a href="../../move-stdlib/doc/string.md#0x1_string_String">string::String</a>, function_name: <a href="../../move-stdlib/doc/string.md#0x1_string_String">string::String</a>, account_identity: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_derive_domain_account_address_view">derive_domain_account_address_view</a>(
    module_address: <b>address</b>,
    module_name: String,
    function_name: String,
    account_identity: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;
): <b>address</b> {
    <a href="account_abstraction.md#0x1_account_abstraction_derive_domain_account_address">derive_domain_account_address</a>(
...
<a id="0x1_account_abstraction_derive_domain_account_address"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_derive_domain_account_address">derive_domain_account_address</a>(domain_func_info: <a href="function_info.md#0x1_function_info_FunctionInfo">function_info::FunctionInfo</a>, account_identity: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_derive_domain_account_address">derive_domain_account_address</a>(domain_func_info: FunctionInfo, account_identity: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <b>address</b> {
    // using <a href="../../move-stdlib/doc/bcs.md#0x1_bcs">bcs</a> serialized structs here - this allows for no need for separators.
    // Alternative would've been <b>to</b> create unique <a href="../../move-stdlib/doc/string.md#0x1_string">string</a>, we would need <b>to</b> convert domain_func_info into <a href="../../move-stdlib/doc/string.md#0x1_string">string</a>,
    // then authentication_key <b>to</b> hex, and then we need separators <b>as</b> well - like ::
    let bytes = <a href="../../move-stdlib/doc/bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&domain_func_info);
    bytes.append(<a href="../../move-stdlib/doc/bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(account_identity));
...
<pre><code><b>public</b> entry <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_register_domain_with_authentication_function">register_domain_with_authentication_function</a>(nabob_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, module_address: <b>address</b>, module_name: <a href="../../move-stdlib/doc/string.md#0x1_string_String">string::String</a>, function_name: <a href="../../move-stdlib/doc/string.md#0x1_string_String">string::String</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_register_domain_with_authentication_function">register_domain_with_authentication_function</a>(
    ...
    <b>borrow_global_mut</b>&lt;<a href="account_abstraction.md#0x1_account_abstraction_DomainDispatchableAuthenticator">DomainDispatchableAuthenticator</a>&gt;(@nabob_framework).auth_functions.add(
        <a href="function_info.md#0x1_function_info_new_function_info_from_address">function_info::new_function_info_from_address</a>(module_address, module_name, function_name),
...
<pre><code>entry <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_initialize">initialize</a>(nabob_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code>inline <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_resource_addr">resource_addr</a>(source: <b>address</b>): <b>address</b> {
    <a href="object.md#0x1_object_create_user_derived_object_address">object::create_user_derived_object_address</a>(source, @nabob_fungible_asset)
}
</code></pre>
...
<a id="0x1_account_abstraction_dispatchable_domain_authenticator_internal"></a>

## Function `dispatchable_domain_authenticator_internal`



<pre><code><b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_dispatchable_domain_authenticator_internal">dispatchable_domain_authenticator_internal</a>(): &<a href="big_ordered_map.md#0x1_big_ordered_map_BigOrderedMap">big_ordered_map::BigOrderedMap</a>&lt;<a href="function_info.md#0x1_function_info_FunctionInfo">function_info::FunctionInfo</a>, <a href="account_abstraction.md#0x1_account_abstraction_DomainRegisterValue">account_abstraction::DomainRegisterValue</a>&gt;
</code></pre>
...
<pre><code>inline <b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_dispatchable_domain_authenticator_internal">dispatchable_domain_authenticator_internal</a>(): &BigOrderedMap&lt;FunctionInfo, <a href="account_abstraction.md#0x1_account_abstraction_DomainRegisterValue">DomainRegisterValue</a>&gt; {
    <b>assert</b>!(<b>exists</b>&lt;<a href="account_abstraction.md#0x1_account_abstraction_DomainDispatchableAuthenticator">DomainDispatchableAuthenticator</a>&gt;(@nabob_framework), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="account_abstraction.md#0x1_account_abstraction_EDOMAIN_AA_NOT_INITIALIZED">EDOMAIN_AA_NOT_INITIALIZED</a>));
    &<b>borrow_global</b>&lt;<a href="account_abstraction.md#0x1_account_abstraction_DomainDispatchableAuthenticator">DomainDispatchableAuthenticator</a>&gt;(@nabob_framework).auth_functions
}
</code></pre>
...
<pre><code><b>fun</b> <a href="account_abstraction.md#0x1_account_abstraction_authenticate">authenticate</a>(
...
): <a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a> <b>acquires</b> <a href="account_abstraction.md#0x1_account_abstraction_DispatchableAuthenticator">DispatchableAuthenticator</a>, <a href="account_abstraction.md#0x1_account_abstraction_DomainDispatchableAuthenticator">DomainDispatchableAuthenticator</a> {
    ...
    <b>if</b> (signing_data.is_domain()) {
        <b>assert</b>!(master_signer_addr == <a href="account_abstraction.md#0x1_account_abstraction_derive_domain_account_address">derive_domain_account_address</a>(func_info, signing_data.domain_account_identity()), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_state">error::invalid_state</a>(<a href="account_abstraction.md#0x1_account_abstraction_EINCONSISTENT_SIGNER_ADDRESS">EINCONSISTENT_SIGNER_ADDRESS</a>));

        <b>let</b> func_infos = <a href="account_abstraction.md#0x1_account_abstraction_dispatchable_domain_authenticator_internal">dispatchable_domain_authenticator_internal</a>();
        <b>assert</b>!(func_infos.contains(&func_info), <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="account_abstraction.md#0x1_account_abstraction_EFUNCTION_INFO_EXISTENCE">EFUNCTION_INFO_EXISTENCE</a>));
    } <b>else</b> {
