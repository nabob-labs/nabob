module nabob_framework::staking_proxy {
    use std::error;
    use std::signer;
    use std::vector;
    ...
    public entry fun set_stake_pool_voter(owner: &signer, new_voter: address) {
        check_stake_proxy_permission(owner);
        if (stake::stake_pool_exists(permissioned_signer::address_of(owner))) {
    ...
    public entry fun test_set_operator(
        ...
        vesting::setup(
            nabob_framework, &vector[owner_address, operator_1_address, operator_2_address, new_operator_address]);
        staking_contract::setup_staking_contract(nabob_framework, owner, operator_1, INITIAL_BALANCE, 0);
        staking_contract::setup_staking_contract(nabob_framework, owner, operator_2, INITIAL_BALANCE, 0);
    ...
    public entry fun test_set_voter(
        ...
        vesting::setup(
            nabob_framework, &vector[owner_address, operator_1_address, operator_2_address, new_voter_address]);
        staking_contract::setup_staking_contract(nabob_framework, owner, operator_1, INITIAL_BALANCE, 0);
        staking_contract::setup_staking_contract(nabob_framework, owner, operator_2, INITIAL_BALANCE, 0);
