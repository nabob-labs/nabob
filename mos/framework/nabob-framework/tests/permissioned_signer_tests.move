#[test_only]
module nabob_framework::permissioned_signer_tests {
    use std::bcs;
    use std::features;
    use nabob_framework::account::create_signer_for_test;
    ...
    fun test_permission_e2e(creator: &signer) {
        let nabob_framework = create_signer_for_test(@0x1);
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50005, location = nabob_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50002, location = nabob_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50001, location = nabob_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50007, location = nabob_framework::permissioned_signer
    )]
    ...
    #[expected_failure(
        abort_code = 0x50008, location = nabob_framework::permissioned_signer
    )]
