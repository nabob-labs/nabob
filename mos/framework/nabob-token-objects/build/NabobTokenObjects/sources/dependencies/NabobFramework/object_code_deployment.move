...
module nabob_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::vector;
    use nabob_framework::account;
    use nabob_framework::code;
    use nabob_framework::code::PackageRegistry;
    use nabob_framework::event;
    use nabob_framework::object;
    use nabob_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"nabob_framework::object_code_deployment";
