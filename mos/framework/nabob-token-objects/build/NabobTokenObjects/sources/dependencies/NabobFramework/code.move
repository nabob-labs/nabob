...
module nabob_framework::code {
    ...
    use nabob_framework::util;
    use nabob_framework::system_addresses;
    use nabob_std::copyable_any::Any;
    ...
    friend nabob_framework::object_code_deployment;
    ...
    fun initialize(nabob_framework: &signer, package_owner: &signer, metadata: PackageMetadata)
