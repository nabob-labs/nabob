...
module nabob_framework::primary_fungible_store {
    use nabob_framework::dispatchable_fungible_asset;
    use nabob_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    use nabob_framework::object::{Self, Object, ConstructorRef, DeriveRef};
    ...
    public fun grant_bob_permission(
        master: &signer,
        permissioned: &signer,
        amount: u64
    ) {
        fungible_asset::grant_permission_by_address(
            master,
            permissioned,
            object::create_user_derived_object_address(permissioned_signer::address_of(permissioned), @nabob_fungible_asset),
            amount
        );
    }
