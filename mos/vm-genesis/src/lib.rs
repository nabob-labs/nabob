...
pub fn encode_nabob_mainnet_genesis_transaction(
    ...
    let module_storage = state_view.as_nabob_code_storage(genesis_runtime_environment.clone());
...
fn code_to_writes_for_loader_v2_publishing(
    ...
    let module_storage =
        genesis_state_view.as_nabob_code_storage(genesis_runtime_environment.clone());
