...
//! see the [coding guidelines](https://nabob.dev/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use nabob_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::nabob_logger::{
    NabobData as Logger, NabobDataBuilder, LoggerFilterUpdater, Writer, CHANNEL_SIZE,
};
pub use nabob_log_derive::Schema;
pub use event::Event;
