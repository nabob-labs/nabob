...
use anyhow::anyhow;
use nabob_aggregator::types::DelayedFieldValue;
...
use nabob_vm_types::{resolver::ResourceGroupSize, resource_group_adapter::group_size_as_sum};
...
> {
    ...
    module_cache:
        UnsyncModuleCache<ModuleId, CompiledModule, Module, NabobModuleExtension, Option<TxnIndex>>,
    ...
    > UnsyncMap<K, T, V, I>
{
    ...
    fn insert_group_op(
        ...
        use nabob_types::write_set::WriteOpKind::*;
