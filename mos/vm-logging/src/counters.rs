...
use nabob_metrics_core::{register_int_counter, IntCounter};
...
pub static CRITICAL_ERRORS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!("nabob_vm_critical_errors", "Number of critical errors").unwrap()
});
...
pub static SPECULATIVE_LOGGING_ERRORS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "nabob_vm_speculative_logging_errors",
