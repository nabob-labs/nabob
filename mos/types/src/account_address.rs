...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"nabob_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"nabob_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"nabob_framework::vesting";
...
// See this issue for potential improvements: https://github.com/nabob-labs/nabob/issues/3960
...
mod hasher {
    #[derive(serde::Deserialize, nabob_crypto_derive::CryptoHasher)]
