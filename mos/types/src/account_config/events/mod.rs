...
pub fn is_nabob_governance_create_proposal_event(event_type: &str) -> bool {
    event_type == "0x1::nabob_governance::CreateProposal"
        || event_type == "0x1::nabob_governance::CreateProposalEvent"
}
