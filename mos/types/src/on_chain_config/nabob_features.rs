...
pub enum FeatureFlag {
    ...
    PRIMARY_BOB_FUNGIBLE_STORE_AT_USER_ADDRESS = 61,
    OBJECT_NATIVE_DERIVED_ADDRESS = 62,
    DISPATCHABLE_FUNGIBLE_ASSET = 63,
    NEW_ACCOUNTS_DEFAULT_TO_FA_BOB_STORE = 64,
    OPERATIONS_DEFAULT_TO_FA_BOB_STORE = 65,
    ...
    /// AIP-105 (https://github.com/nabob-foundation/AIPs/blob/main/aips/aip-105.md)
    ...
    /// AIP-103 (https://github.com/nabob-foundation/AIPs/blob/main/aips/aip-103.md)
...
impl FeatureFlag {
    pub fn default_features() -> Vec<Self> {
        vec![
            ...
            FeatureFlag::NABOB_STD_CHAIN_ID_NATIVES,
            ...
            FeatureFlag::NABOB_UNIQUE_IDENTIFIERS,
...
pub fn nabob_test_feature_flags_genesis() -> ChangeSet {
