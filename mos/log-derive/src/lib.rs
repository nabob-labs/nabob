...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::nabob_logger::Value::from_serde };
    let from_display = quote! { ::nabob_logger::Value::from_display };
    let from_debug = quote! { ::nabob_logger::Value::from_debug };
    let key_new = quote! { ::nabob_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::nabob_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::nabob_logger::Visitor) {
                #(#visits)*
            }
        }
    };
