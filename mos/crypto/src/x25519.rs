...
//!
//! ```
//! use nabob_crypto::{x25519, Uniform, test_utils::TEST_SEED};
...
//! use nabob_crypto::traits::ValidCryptoMaterialStringExt;
//! # fn main() -> Result<(), nabob_crypto::traits::CryptoMaterialError> {
