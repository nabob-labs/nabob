...
//! use the derive macros of `serde` and `nabob_crypto_derive` as follows:
//! ```
...
//!
//! ```
//! use nabob_crypto::hash::{CryptoHasher, TestOnlyHasher};
//!
...
pub(crate) const HASH_PREFIX: &[u8] = b"NABOB::";
