...
//! ```
//! use std::iter::zip;
//! use nabob_crypto::test_utils::{KeyPair, TestNabobCrypto};
//! use nabob_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use nabob_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use nabob_crypto::bls12381::ProofOfPossession;
//! use nabob_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/nabob-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestNabobCrypto("test".to_owned());
...
//! use nabob_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use nabob_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use nabob_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use nabob_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use nabob_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/nabob-crypto/`
...
//! // signature on TestNabobCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use nabob_crypto::test_utils::KeyPair;
//! use nabob_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use nabob_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use nabob_crypto::bls12381::ProofOfPossession;
//! use nabob_crypto_derive::{CryptoHasher, BCSCryptoHash};
