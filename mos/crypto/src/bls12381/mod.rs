...
//! //
//! // Here, we'll sign an existing testing struct from `mos/crypto/src/test_utils.rs`:
//! //
...
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `mos/crypto/`
