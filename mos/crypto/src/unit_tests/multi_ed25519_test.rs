...
use crate::{
    ...
    test_utils::{TestNabobCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestNabobCrypto> = Lazy::new(|| TestNabobCrypto("Test Message".to_string()));
fn message() -> &'static TestNabobCrypto {
    &MESSAGE
}
