...
use crate::move_vm_ext::{NabobMoveResolver, SessionExt};
use nabob_framework::{KnownAttribute, RandomnessAnnotation};
use nabob_types::transaction::EntryFunction;
...
pub(crate) fn get_randomness_annotation(
    ...
    let metadata = nabob_framework::get_metadata_from_compiled_module(&module);
