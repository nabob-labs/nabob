...
use crate::{
    ...
    move_vm_ext::{
        resource_state_key, write_op_converter::WriteOpConverter, NabobMoveResolver, SessionId,
    },
};
use nabob_framework::natives::{
...
use nabob_table_natives::{NativeTableContext, TableChangeSet};
use nabob_types::{
...
pub struct SessionExt<'r, 'l> {
    inner: Session<'r, 'l>,
    resolver: &'r dyn NabobMoveResolver,
    is_storage_slot_metadata_enabled: bool,
}

impl<'r, 'l> SessionExt<'r, 'l> {
    pub(crate) fn new<R: NabobMoveResolver>(
    ...
    fn split_and_merge_resource_groups(
        resolver: &dyn NabobMoveResolver,
        module_storage: &impl ModuleStorage,
