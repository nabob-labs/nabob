...
use crate::move_vm_ext::{session::BytesWithResourceLayout, NabobMoveResolver};
use nabob_aggregator::delta_change_set::serialize;
use nabob_types::{
...
pub(crate) struct WriteOpConverter<'r> {
    remote: &'r dyn NabobMoveResolver,
...
mod tests {
    ...
    use nabob_vm_types::{
        module_and_script_storage::AsNabobCodeStorage,
    ...
    // TODO: Can re-use some of these testing definitions with nabob-vm-types.
