...
use crate::{move_vm_ext::NabobMoveResolver, transaction_metadata::TransactionMetadata};
use nabob_gas_algebra::{Gas, GasExpression, InternalGas};
use nabob_gas_meter::{StandardGasAlgebra, StandardGasMeter};
use nabob_gas_schedule::{
    gas_feature_versions::RELEASE_V1_13, gas_params::txn::KEYLESS_BASE_COST, NabobGasParameters,
    VMGasParameters,
};
use nabob_logger::{enabled, Level};
use nabob_memory_usage_tracker::MemoryTrackedGasMeter;
use nabob_types::on_chain_config::Features;
use nabob_vm_logging::{log_schema::AdapterLogSchema, speculative_log, speculative_warn};
use nabob_vm_types::{
...
pub(crate) fn check_gas(
    ...
    if crate::nabob_vm::is_account_init_for_sponsored_transaction(
        txn_metadata,
        features,
        resolver,
        module_storage,
