...
use nabob_vm_logging::{flush_speculative_logs, init_speculative_logs};
use nabob_vm_types::{
...
use vm_wrapper::NabobExecutorTask;
...
#[derive(Debug)]
pub struct NabobTransactionOutput {
...
impl BlockExecutorTransactionOutput for NabobTransactionOutput {
...
pub struct NabobBlockExecutorWrapper<
    E: ExecutorTask<
        Txn = SignatureVerifiedTransaction,
        Error = VMStatus,
        Output = NabobTransactionOutput,
    >,
> {
...
impl<
        E: ExecutorTask<
            ...
            Output = NabobTransactionOutput,
        >,
    > NabobBlockExecutorWrapper<E>
{
    pub fn execute_block_on_thread_pool<
        S: StateView + Sync,
        L: TransactionCommitHook<Output = NabobTransactionOutput>,
...
// Same as NabobBlockExecutorWrapper with NabobExecutorTask
pub type NabobVMBlockExecutorWrapper = NabobBlockExecutorWrapper<NabobExecutorTask>;
