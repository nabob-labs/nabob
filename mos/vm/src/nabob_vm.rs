...
impl NabobVM {
    ...
    fn extract_module_metadata(
        ...
        if self.features().is_enabled(FeatureFlag::VM_BINARY_FORMAT_V6) {
            nabob_framework::get_vm_metadata(module_storage, module_id)
        } else {
            nabob_framework::get_vm_metadata_v0(module_storage, module_id)
        }
    }
    ...
    pub fn execute_view_function(
        ...
        let vm = NabobVM::new(&env, state_view);
