...
#[cfg(feature = "testing")]
use nabob_aggregator::resolver::TAggregatorV1View;
#[cfg(feature = "testing")]
use nabob_aggregator::{bounded_math::SignedU128, types::DelayedFieldsSpeculativeError};
#[cfg(feature = "testing")]
use nabob_aggregator::{resolver::TDelayedFieldView, types::DelayedFieldValue};
#[cfg(feature = "testing")]
use nabob_framework::natives::randomness::RandomnessContext;
#[cfg(feature = "testing")]
use nabob_framework::natives::{cryptography::algebra::AlgebraContext, event::NativeEventContext};
...
#[cfg(feature = "testing")]
use nabob_table_natives::{TableHandle, TableResolver};
use nabob_types::on_chain_config::{Features, TimedFeatures, TimedFeaturesBuilder};
#[cfg(feature = "testing")]
use nabob_types::{
    chain_id::ChainId,
...
use nabob_vm_environment::natives::nabob_natives_with_builder;
#[cfg(feature = "testing")]
use bytes::Bytes;
#[cfg(feature = "testing")]
...
#[cfg(feature = "testing")]
struct NabobBlankStorage;

#[cfg(feature = "testing")]
impl NabobBlankStorage {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[cfg(feature = "testing")]
impl TAggregatorV1View for NabobBlankStorage {
...
#[cfg(feature = "testing")]
impl TDelayedFieldView for NabobBlankStorage {
...
#[cfg(feature = "testing")]
impl TableResolver for NabobBlankStorage {
...
static DUMMY_RESOLVER: Lazy<NabobBlankStorage> = Lazy::new(|| NabobBlankStorage::new());

pub fn nabob_natives(
    ...
    nabob_natives_with_builder(&mut builder, false)
}
...
fn unit_test_extensions_hook(exts: &mut NativeContextExtensions) {
    use nabob_framework::natives::object::NativeObjectContext;
    use nabob_table_natives::NativeTableContext;
