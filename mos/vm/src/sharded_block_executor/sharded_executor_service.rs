...
use crate::{
    block_executor::NabobVMBlockExecutorWrapper,
...
use nabob_block_executor::{
    code_cache_global_manager::NabobModuleCacheManager, txn_provider::default::DefaultTxnProvider,
};
use nabob_logger::{info, trace};
use nabob_types::{
    block_executor::{
...
use nabob_vm_logging::disable_speculative_logging;
    ...
    pub fn execute_transactions_with_dependencies(
        ...
        executor_thread_pool.clone().scope(|s| {
            ...
            s.spawn(move |_| {
                ...
                let ret = NabobVMBlockExecutorWrapper::execute_block_on_thread_pool(
                    executor_thread_pool,
                    &txn_provider,
