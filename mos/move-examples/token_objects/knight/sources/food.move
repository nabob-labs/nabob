...
module knight::food {
    use nabob_framework::fungible_asset::{Self, Metadata};
    use nabob_framework::object::{Self, Object};
    use nabob_framework::primary_fungible_store;
    use nabob_token_objects::collection;
    use nabob_token_objects::property_map;
    use nabob_token_objects::token;
    use std::error;
    use std::option;
    use std::signer;
    ...
    fun init_module(sender: &signer) {
        ...
        create_food_token_as_fungible_token(
            ...
            string::utf8(b"https://raw.githubusercontent.com/nabob-labs/nabob/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn"),
            string::utf8(b"Corn"),
            string::utf8(b"CORN"),
            string::utf8(b"https://raw.githubusercontent.com/nabob-labs/nabob/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn.png"),
            string::utf8(b"https://www.naboblabs.com"),
            5,
        );
        create_food_token_as_fungible_token(
            sender,
            ...
            string::utf8(b"https://raw.githubusercontent.com/nabob-labs/nabob/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat"),
            string::utf8(b"Meat"),
            string::utf8(b"MEAT"),
            string::utf8(b"https://raw.githubusercontent.com/nabob-labs/nabob/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat.png"),
            string::utf8(b"https://www.naboblabs.com"),
            20,
        );
    }
