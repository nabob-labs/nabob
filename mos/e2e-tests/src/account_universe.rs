...
//! A model to test properties of common Nabob transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common Nabob
...
pub fn txn_one_account_result(
    ...
    // The transactions set the gas cost to 1 micronabob.
...
pub fn assert_accounts_match(
    ...
    for (idx, account) in universe.accounts().iter().enumerate() {
        ...
        let coin_store_resource = executor
            .read_bob_coin_store_resource(account.account())
