...
//! Support for mocking the Nabob data store.
...
impl FakeDataStore {
    ...
    pub fn add_coin_info(&mut self) {
        let coin_info = CoinInfoResource::<NabobCoinType>::random(u128::MAX);
...
mod test {
    use super::*;
    use nabob_types::on_chain_config::{FeatureFlag, Features};
    use claims::*;
