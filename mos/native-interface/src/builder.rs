...
use nabob_gas_schedule::{MiscGasParameters, NativeGasParameters, ToOnChainGasSchedule};
use nabob_types::on_chain_config::{Features, TimedFeatures};
use bytes::Bytes;
...
impl SafeNativeBuilder {
    ...
    ///
    /// The closure will have access to the common Nabob configurations (features, gas params etc.),
