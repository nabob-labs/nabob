...
use nabob_types::state_store::state_value::StateValueMetadata;
...
/// Represents module storage used by the Nabob blockchain.
pub trait NabobModuleStorage: ModuleStorage {
