...
use crate::traits::{NabobGasMeter, GasAlgebra};
use nabob_gas_algebra::{Fee, FeePerGasUnit, NumTypeNodes};
...
/// The official gas meter used inside the Nabob VM.
...
impl<A> NabobGasMeter for StandardGasMeter<A>
where
    A: GasAlgebra,
{
    type Algebra = A;
