...
use anyhow::bail;
use nabob_crypto::{bls12381, CryptoMaterialError, Genesis, SigningKey, ValidCryptoMaterial};
...
const DAS_PVSS_FIAT_SHAMIR_DST: &[u8; 30] = b"NABOB_DAS_PVSS_FIAT_SHAMIR_DST";
