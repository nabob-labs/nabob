...
use nabob_crypto::{CryptoMaterialError, ValidCryptoMaterial, ValidCryptoMaterialStringExt};
use nabob_crypto_derive::{DeserializeKey, SerializeKey};
...
pub const DST_PVSS_PUBLIC_PARAMS: &[u8; 32] = b"NABOB_DISTRIBUTED_RANDOMNESS_DST";
/// "Nothing up my sleeve" seed to deterministically-derive the public parameters.
pub const SEED_PVSS_PUBLIC_PARAMS: &[u8; 33] = b"NABOB_DISTRIBUTED_RANDOMNESS_SEED";
...
impl Default for PublicParameters {
    /// Verifiably creates Nabob-specific public parameters.
    fn default() -> Self {
