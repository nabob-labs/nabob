...
impl StdLib {
    ...
    const STD_GIT_URL: &'static str = "https://github.com/nabob-labs/nabob-framework.git";
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            StdLib::NabobToken => "NabobToken",
            StdLib::NabobTokenObjects => "NabobTokenObjects",
            StdLib::NabobFramework => "NabobFramework",
            StdLib::NabobStdlib => "NabobStdlib",
    ...
    pub fn from_package_name(package_name: Symbol) -> Option<StdLib> {
        match package_name.as_str() {
            "NabobToken" => Some(StdLib::NabobToken),
            "NabobTokenObjects" => Some(StdLib::NabobTokenObjects),
            "NabobFramework" => Some(StdLib::NabobFramework),
            "NabobStdlib" => Some(StdLib::NabobStdlib),
    ...
    fn sub_dir(&self) -> &'static str {
        match self {
            StdLib::NabobToken => "nabob-token",
            StdLib::NabobTokenObjects => "nabob-token-objects",
            StdLib::NabobFramework => "nabob-framework",
            StdLib::NabobStdlib => "nabob-stdlib",
