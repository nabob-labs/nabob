...
pub const WARN_OF_DEPRECATION_USE_IN_NABOB_LIBS: &str = "WARN_OF_DEPRECATION_USE_IN_NABOB_LIBS";
pub const WARN_OF_DEPRECATION_USE_IN_NABOB_LIBS_FLAG: &str = "Wdeprecation-nabob";
