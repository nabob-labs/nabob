...
pub fn benchmark(args: &[String]) {
    let cmd_line_parser = Command::new("benchmark")
        ...
        .arg(
            Arg::new("nabob-natives")
                .short('a')
                .long("nabob")
                .num_args(0)
                .action(Set)
                .help("whether the nabob-natives should be included."),
        )
        .arg(
    ...
    let use_nabob_natives = matches.contains_id("nabob-natives");
