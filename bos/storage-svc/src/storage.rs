...
use nabob_config::config::StorageServiceConfig;
use nabob_logger::debug;
use nabob_storage_interface::{NabobDbError, DbReader, Result as StorageResult};
use nabob_storage_types::responses::{
...
/// The interface into local storage (e.g., the Nabob DB) used by the storage
...
pub trait StorageReaderInterface: Clone + Send + 'static {
    ...
    fn get_data_summary(&self) -> nabob_storage_types::Result<DataSummary, Error>;
    ...
    fn get_transactions_with_proof(
        ...
        end_version: u64,
        include_events: bool,
    ) -> nabob_storage_types::Result<TransactionListWithProof, Error>;
    ...
    ) -> nabob_storage_types::Result<EpochChangeProof, Error>;
    ...
    fn get_transaction_outputs_with_proof(
        ...
        start_version: u64,
        end_version: u64,
    ) -> nabob_storage_types::Result<TransactionOutputListWithProof, Error>;
    ...
    fn get_state_value_chunk_with_proof(
        ...
        start_index: u64,
        end_index: u64,
    ) -> nabob_storage_types::Result<StateValueChunkWithProof, Error>;
}
...
impl StorageReader {
    ...
    ) -> nabob_storage_types::Result<Option<CompleteDataRange<Version>>, Error> {
    ...
    ($(
        ...
        $(
            ...
            fn $name(&self, $($arg: $ty),*) -> $return_type {
                ...
                result.map_err(|e| NabobDbError::Other(e.to_string()))
            }
        )+
    };
}
...
/// `end == u64::MAX`.
fn inclusive_range_len(start: u64, end: u64) -> nabob_storage_types::Result<u64, Error> {
    // len = end - start + 1
...
) -> nabob_storage_types::Result<(bool, u64), Error> {
