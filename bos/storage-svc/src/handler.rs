...
use nabob_config::{config::StorageServiceConfig, network_id::PeerNetworkId};
use nabob_logger::{debug, sample, sample::SampleRate, trace, warn};
use nabob_network::protocols::wire::handshake::v1::ProtocolId;
...
impl<T: StorageReaderInterface> Handler<T> {
    ...
    ) -> nabob_storage_types::Result<StorageServiceResponse> {
    ...
    pub(crate) fn send_response(
        &self,
        request: StorageServiceRequest,
        response: nabob_storage_types::Result<StorageServiceResponse>,
        response_sender: ResponseSender,
    ) {
    ...
    fn process_cachable_request(
        ...
        peer_network_id: &PeerNetworkId,
        request: &StorageServiceRequest,
    ) -> nabob_storage_types::Result<StorageServiceResponse, Error> {
    ...
    ) -> nabob_storage_types::Result<DataResponse, Error> {
...
fn log_storage_response(
    ...
    storage_response: &nabob_storage_types::Result<
