...
use nabob_types::{account_address::AccountAddress, on_chain_config::ValidatorSet};
...
pub struct RestStream {
    ...
    rest_client: nabob_rest_cli::Client,
...
impl RestStream {
    pub(crate) fn new(
        ...
        RestStream {
            network_context,
            rest_client: nabob_rest_cli::Client::new(rest_url),
