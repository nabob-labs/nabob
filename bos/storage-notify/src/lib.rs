...
pub fn new_storage_service_notifier_listener_pair(
    ...
    let (notification_sender, notification_receiver) = nabob_channel::new(
        QueueStyle::LIFO,
...
pub struct StorageServiceNotifier {
    notification_sender: nabob_channel::Sender<(), StorageServiceCommitNotification>,
}
...
pub struct StorageServiceNotificationListener {
    notification_receiver: nabob_channel::Receiver<(), StorageServiceCommitNotification>,
}
