...
pub(crate) const ENV_NABOB_DISABLE_TELEMETRY: &str = "NABOB_DISABLE_TELEMETRY";
pub(crate) const ENV_NABOB_FORCE_ENABLE_TELEMETRY: &str = "NABOB_FORCE_ENABLE_TELEMETRY";
pub(crate) const ENV_NABOB_DISABLE_TELEMETRY_PUSH_METRICS: &str =
    "NABOB_DISABLE_TELEMETRY_PUSH_METRICS";
pub(crate) const ENV_NABOB_DISABLE_TELEMETRY_PUSH_LOGS: &str = "NABOB_DISABLE_TELEMETRY_PUSH_LOGS";
pub(crate) const ENV_NABOB_DISABLE_TELEMETRY_PUSH_EVENTS: &str =
    "NABOB_DISABLE_TELEMETRY_PUSH_EVENTS";
pub(crate) const ENV_NABOB_DISABLE_PROMETHEUS_NODE_METRICS: &str =
    "NABOB_DISABLE_PROMETHEUS_NODE_METRICS";
pub(crate) const ENV_NABOB_DISABLE_LOG_ENV_POLLING: &str = "NABOB_DISABLE_LOG_ENV_POLLING";
...
pub(crate) const NABOB_GA_MEASUREMENT_ID: &str = "G-ZX4L6WPCFZ";
pub(crate) const NABOB_GA_API_SECRET: &str = "ArtslKPTTjeiMi1n-IR39g";
...
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.naboblabs.com";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.naboblabs.com";
