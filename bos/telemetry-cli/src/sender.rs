...
use nabob_config::config::{NodeConfig, RoleType};
use nabob_crypto::{
...
mod tests {
    ...
    use super::*;
    use crate::metrics::{NABOB_TELEMETRY_SERVICE_FAILURE, NABOB_TELEMETRY_SERVICE_SUCCESS};
