...
pub(crate) static NABOB_TELEMETRY_SERVICE_SUCCESS: Lazy<IntCounterVec> = Lazy::new(|| {
...
pub(crate) static NABOB_TELEMETRY_SERVICE_FAILURE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "nabob_telemetry_svc_failure",
...
pub(crate) static NABOB_TELEMETRY_SUCCESS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "nabob_telemetry_success",
...
/// TODO: Clean up when cleaning up telemetry exporter to GA
pub(crate) static NABOB_TELEMETRY_FAILURE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "nabob_telemetry_failure",
...
pub(crate) fn increment_telemetry_service_failures(event_name: &str) {
    NABOB_TELEMETRY_SERVICE_FAILURE
        .with_label_values(&[event_name])
        .inc();
}

/// Counter for successful log ingest events sent to Telemetry Service
pub(crate) static NABOB_LOG_INGEST_SUCCESS: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "nabob_log_ingest_success",
...
/// Counter for successful log ingest events sent to Telemetry Service
pub(crate) static NABOB_LOG_INGEST_TOO_LARGE: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "nabob_log_ingest_too_large",
...
pub(crate) static NABOB_LOG_INGEST_FAILURE: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "nabob_log_ingest_failure",
