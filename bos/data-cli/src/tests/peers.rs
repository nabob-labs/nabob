...
use nabob_config::{
    config::{NabobDataClientConfig, NabobDataMultiFetchConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use nabob_storage_svc::network::NetworkRequest;
use nabob_storage_types::{
    requests::DataRequest,
    responses::{CompleteDataRange, DataResponse, StorageServerSummary, StorageServiceResponse},
    StorageServiceError,
};
use nabob_types::transaction::TransactionListWithProof;
...
async fn all_bad_peers_with_invalid_responses() {
    ...
    for peer_priority in PeerPriority::get_all_ordered_priorities() {
        ...
        let data_client_config = NabobDataClientConfig {
            data_multi_fetch_config: NabobDataMultiFetchConfig {
...
fn verify_peer_states(client: &NabobDataClient, all_peers: HashSet<PeerNetworkId>) {
