...
use nabob_config::{
    config::{NabobDataClientConfig, NabobDataMultiFetchConfig, NabobLatencyFilteringConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use nabob_storage_types::requests::{DataRequest, StorageServiceRequest};
use nabob_time_svc::TimeServiceTrait;
use maplit::hashset;
...
async fn request_latency_filtering() {
    ...
    let data_client_config = NabobDataClientConfig {
        ...
        latency_filtering_config: NabobLatencyFilteringConfig {
