...
use nabob_storage_types::{responses::TransactionOrOutputListWithProof, Epoch};
use nabob_types::{
...
/// The API offered by the Nabob Data Client.
#[async_trait]
pub trait NabobDataClientInterface {
...
/// A response error that users of the Nabob Data Client can use to notify
