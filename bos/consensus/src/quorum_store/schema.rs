...
use anyhow::Result;
use nabob_consensus_types::proof_of_store::BatchId;
...
impl Schema for BatchSchema {
    ...
    const COLUMN_FAMILY_NAME: nabob_schemadb::ColumnFamilyName = BATCH_CF_NAME;
}
...
impl Schema for BatchIdSchema {
    ...
    const COLUMN_FAMILY_NAME: nabob_schemadb::ColumnFamilyName = BATCH_ID_CF_NAME;
}
