...
use nabob_config::config::ConsensusConfig;
...
use nabob_infallible::{checked, Mutex};
use nabob_logger::prelude::*;
#[cfg(test)]
use nabob_safety_rules::ConsensusState;
use nabob_safety_rules::TSafetyRules;
...
pub struct RoundManager {
    ...
    buffered_proposal_tx: nabob_channel::Sender<Author, VerifiedEvent>,
...
impl RoundManager {
    ...
    async fn resend_verified_proposal_to_self(
        block_store: Arc<BlockStore>,
        self_sender: nabob_channel::Sender<Author, VerifiedEvent>,
        proposal: Block,
        author: Author,
    ...
    pub async fn start(
        mut self,
        mut event_rx: nabob_channel::Receiver<
            (Author, Discriminant<VerifiedEvent>),
            (Author, VerifiedEvent),
        >,
        mut buffered_proposal_rx: nabob_channel::Receiver<Author, VerifiedEvent>,
