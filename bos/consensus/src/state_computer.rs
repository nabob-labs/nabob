...
use nabob_metrics_core::IntGauge;
use nabob_types::{
...
pub struct ExecutionProxy {
    ...
    pre_commit_notifier: nabob_channels::Sender<NotificationType>,
    commit_notifier: nabob_channels::Sender<NotificationType>,
...
impl ExecutionProxy {
    ...
    ) -> nabob_channels::Sender<NotificationType> {
        let (tx, mut rx) = nabob_channels::new::<NotificationType>(10, pending_notifications_gauge);
...
async fn test_commit_sync_race() {
    ...
    use nabob_config::config::transaction_filter_type::Filter;
    use nabob_consensus_notify::Error;
