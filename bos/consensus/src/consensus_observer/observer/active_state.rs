...
impl ActiveObserverState {
    ...
    pub async fn wait_for_epoch_start(
        &mut self,
        block_payloads: Arc<
            Mutex<BTreeMap<(u64, nabob_consensus_types::common::Round), BlockPayloadStatus>>,
        >,
    ) -> (
...
mod test {
    ...
    fn create_and_add_ordered_blocks(
        ...
        for i in 0..num_ordered_blocks {
            ...
            let ordered_proof =
                create_ledger_info(epoch, i as nabob_consensus_types::common::Round);
    ...
    fn create_ledger_info(
        epoch: u64,
        round: nabob_consensus_types::common::Round,
    ...
    fn create_reconfig_notifier_and_listener() -> (
        nabob_channel::Sender<(), ReconfigNotification<DbBackedOnChainConfig>>,
