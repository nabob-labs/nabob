...
use nabob_crypto::{bls12381, Genesis};
use nabob_event_notify::{DbBackedOnChainConfig, ReconfigNotificationListener};
use nabob_executor_types::state_compute_result::StateComputeResult;
...
impl ConsensusObserver {
    ...
    async fn wait_for_epoch_start(&mut self) {
        ...
        let (_, rand_msg_rx) =
            nabob_channel::new::<AccountAddress, IncomingRandGenRequest>(QueueStyle::FIFO, 1, None);
