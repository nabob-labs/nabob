...
use nabob_config::config::{ConsensusConfig, ConsensusObserverConfig};
use nabob_consensus_types::{
    common::{Author, Round},
    pipelined_block::PipelinedBlock,
};
use nabob_crypto::bls12381::PrivateKey;
use nabob_executor_types::ExecutorResult;
...
struct BufferManagerHandle {
    ...
    pub commit_tx:
        Option<nabob_channel::Sender<AccountAddress, (AccountAddress, IncomingCommitRequest)>>,
...
impl BufferManagerHandle {
    ...
    pub fn init(
        ...
        commit_tx: nabob_channel::Sender<AccountAddress, (AccountAddress, IncomingCommitRequest)>,
...
impl ExecutionProxyClient {
    ...
    fn spawn_decoupled_execution(
        ...
        let (commit_msg_tx, commit_msg_rx) =
            nabob_channel::new::<AccountAddress, (AccountAddress, IncomingCommitRequest)>(
                QueueStyle::FIFO,
                100,
...
impl TExecutionClient for DummyExecutionClient {
    async fn start_epoch(
        ...
        _rand_msg_rx: nabob_channel::Receiver<AccountAddress, IncomingRandGenRequest>,
