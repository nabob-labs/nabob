...
use nabob_event_notify::{DbBackedOnChainConfig, EventSubscriptionService};
use nabob_logger::prelude::*;
use nabob_netcore::transport::tcp::TCPBufferCfg;
use nabob_network::{
...
use nabob_network_discovery::DiscoveryChangeListener;
use nabob_time_svc::TimeService;
use nabob_types::{chain_id::ChainId, network_address::NetworkAddress};
...
impl NetworkBuilder {
    ...
    pub fn conn_mgr_reqs_tx(&self) -> Option<nabob_channels::Sender<ConnectivityRequest>> {
