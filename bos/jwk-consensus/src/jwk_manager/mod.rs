...
use nabob_crypto::{bls12381::PrivateKey, SigningKey};
...
pub struct JWKManager {
    ...
    qc_update_tx: nabob_channel::Sender<Issuer, QuorumCertifiedUpdate>,
    qc_update_rx: nabob_channel::Receiver<Issuer, QuorumCertifiedUpdate>,
...
impl JWKManager {
    pub fn new(
        ...
        let (qc_update_tx, qc_update_rx) = nabob_channel::new(QueueStyle::KLAST, 1, None);
        Self {
            consensus_key,
            my_addr,
            epoch_state,
    ...
    pub async fn run(
        ...
        mut jwk_updated_rx: nabob_channel::Receiver<(), ObservedJWKsUpdated>,
        mut rpc_req_rx: nabob_channel::Receiver<
            AccountAddress,
        ...
        let (local_observation_tx, mut local_observation_rx) =
            nabob_channel::new(QueueStyle::KLAST, 100, None);
