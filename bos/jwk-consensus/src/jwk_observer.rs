...
use nabob_jwk_utils::{fetch_jwks_from_jwks_uri, fetch_jwks_uri_from_openid_config};
use nabob_logger::{debug, info};
use nabob_types::jwks::{jwk::JWK, Issuer};
...
impl JWKObserver {
    pub fn spawn(
        ...
        observation_tx: nabob_channel::Sender<(), (Issuer, Vec<JWK>)>,
    ) -> Self {
