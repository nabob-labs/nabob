...
impl From<nabob_secure_storage::Error> for Error {
    fn from(error: nabob_secure_storage::Error) -> Self {
        match error {
            nabob_secure_storage::Error::PermissionDenied => {
            ...
            nabob_secure_storage::Error::KeyVersionNotFound(_, _)
            | nabob_secure_storage::Error::KeyNotSet(_) => {
