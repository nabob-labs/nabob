...
use nabob_consensus_types::{common::Author, safety_data::SafetyData};
use nabob_crypto::{bls12381, PrivateKey};
use nabob_global_constants::{CONSENSUS_KEY, OWNER_ACCOUNT, SAFETY_DATA, WAYPOINT};
use nabob_logger::prelude::*;
use nabob_secure_storage::{KVStorage, Storage};
...
impl PersistentSafetyStorage {
    ...
    fn initialize_keys_and_accounts(
        ...
        // storage.
        if let Err(nabob_secure_storage::Error::KeyAlreadyExists(_)) = result {
    ...
    pub fn default_consensus_sk(
        &self,
    ) -> Result<bls12381::PrivateKey, nabob_secure_storage::Error> {
        self.internal_store
...
mod tests {
    use super::*;
    use crate::counters;
    use nabob_crypto::hash::HashValue;
    use nabob_secure_storage::InMemoryStorage;
    use nabob_types::{
