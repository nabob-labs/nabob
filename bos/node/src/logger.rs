...
use nabob_logger::{
    nabob_logger::FileWriter, info, telemetry_log_writer::TelemetryLog, LoggerFilterUpdater,
};
...
pub fn create_logger(
    ...
    let mut logger_builder = nabob_logger::Logger::builder();
...
fn log_config_and_build_information(node_config: &NodeConfig) {
    ...
    // with the features defined in the nabob-node Cargo.toml file.
