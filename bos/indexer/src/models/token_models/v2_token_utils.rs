...
use nabob_api_types::{deserialize_from_string, Event, WriteResource};
...
pub struct TokenV2AggregatedData {
    pub nabob_collection: Option<NabobCollection>,
...
impl NabobCollection {
    pub fn from_write_resource(
        ...
        if let V2TokenResource::NabobCollection(inner) =
...
impl V2TokenResource {
    ...
    pub fn from_resource(
        ...
        match data_type {
            ...
            "0x4::nabob_token::NabobCollection" => {
                serde_json::from_value(data.clone()).map(|inner| Some(Self::NabobCollection(inner)))
            },
            "0x4::token::Token" => {
