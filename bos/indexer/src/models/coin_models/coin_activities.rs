...
use nabob_types::{NabobCoinType, CoinType as CoinTypeTrait};
use bigdecimal::BigDecimal;
use field_count::FieldCount;
use serde::{Deserialize, Serialize};
use std::collections::HashMap;

const GAS_FEE_EVENT: &str = "0x1::nabob_coin::GasFeeEvent";
...
impl CoinActivity {
    ...
    fn get_gas_event(
        ...
        Self {
            ...
            coin_type: NabobCoinType::type_tag().to_string(),
            amount: nabob_coin_burned,
