...
impl From<nabob_data_stream_svc::error::Error> for Error {
    fn from(error: nabob_data_stream_svc::error::Error) -> Self {
        Error::UnexpectedError(error.to_string())
    }
}

impl From<nabob_event_notify::Error> for Error {
    fn from(error: nabob_event_notify::Error) -> Self {
