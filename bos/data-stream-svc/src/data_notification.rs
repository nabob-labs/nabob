...
use nabob_data_cli::interface::{Response, ResponsePayload};
use nabob_types::{
...
/// A request that has been sent to the Nabob data client.
#[derive(Clone, Debug, Eq, PartialEq)]
...
pub struct PendingClientResponse {
    ...
    pub client_response: Option<Result<Response<ResponsePayload>, nabob_data_cli::error::Error>>,
}
...
impl PendingClientResponse {
    ...
    pub fn new_with_response(
        ...
        client_response: Result<Response<ResponsePayload>, nabob_data_cli::error::Error>,
    ) -> Self {
        Self {
            client_request,
