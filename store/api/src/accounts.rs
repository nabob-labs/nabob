...
use nabob_api_types::{
    AccountData, Address, NabobErrorCode, AsConverter, AssetType, LedgerInfo, MoveModuleBytecode,
    MoveModuleId, MoveResource, MoveStructTag, StateKeyWrapper, U64,
};
use nabob_sdk::types::{get_paired_fa_metadata_address, get_paired_fa_primary_store_address};
use nabob_types::{
    account_config::{
...
impl AccountsApi {
    ...
    async fn get_account_resources(
        ...
        /// then use the cursor returned in the X-Nabob-Cursor header in the
        /// response.
