...
use nabob_api_types::{
    verify_module_identifier, Address, NabobErrorCode, AsConverter, IdentifierWrapper,
...
use nabob_types::state_store::{state_key::StateKey, table::TableHandle, TStateView};
        ...
        let state_value = state_view
            ...
            .ok_or_else(|| {
                build_not_found(
                    ...
                    NabobErrorCode::StateValueNotFound,
                    &ledger_info,
                )
            })?;
