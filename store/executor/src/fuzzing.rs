...
use nabob_crypto::{hash::SPARSE_MERKLE_PLACEHOLDER_HASH, HashValue};
use nabob_executor_types::BlockExecutorTrait;
use nabob_storage_interface::{chunk_to_commit::ChunkToCommit, DbReader, DbReaderWriter, DbWriter};
use nabob_types::{
    block_executor::{
...
impl DbWriter for FakeDb {
    fn pre_commit_ledger(
        ...
        _sync_commit: bool,
    ) -> nabob_storage_interface::Result<()> {
        Ok(())
    }
