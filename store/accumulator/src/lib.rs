...
use nabob_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use nabob_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`nabob_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`nabob_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`nabob_types::proof::AccumulatorRangeProof`] for proof format.
