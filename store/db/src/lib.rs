...
//! This crate provides [`NabobDB`] which represents physical storage of the core Nabob data
//! structures.
//!
//! It relays read/write operations on the physical storage via `schemadb` to the underlying
//! Key-Value storage system, and implements nabob data structures on top of it.

pub use crate::db::NabobDB;
