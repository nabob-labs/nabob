...
use nabob_config::config::StateMerklePrunerConfig;
use nabob_jellyfish_merkle::StaleNodeIndex;
use nabob_schemadb::schema::KeyCodec;
use nabob_storage_interface::Result;
use nabob_types::transaction::{AtomicVersion, Version};
use std::{
    marker::PhantomData,
    sync::{atomic::Ordering, Arc},
};

/// The `Pruner` is meant to be part of a `NabobDB` instance and runs in the background to prune old
/// data.
///
