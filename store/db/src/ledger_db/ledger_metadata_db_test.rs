...
use crate::{ledger_db::ledger_metadata_db::LedgerMetadataDb, NabobDB};
...
fn set_up(path: &impl AsRef<Path>, ledger_infos_with_sigs: &[LedgerInfoWithSignatures]) -> NabobDB {
    let db = NabobDB::new_for_test(path);
    ...
    ledger_infos_with_sigs
        ...
        .collect::<Result<Vec<_>, NabobDbError>>()
        .unwrap();
