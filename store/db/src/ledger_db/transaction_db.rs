...
use nabob_db_indexer_schemas::schema::transaction_by_account::TransactionByAccountSchema;
...
use nabob_types::transaction::{Transaction, Version};
use rayon::prelude::*;
...
impl TransactionDb {
    ...
    pub(crate) fn get_transaction(&self, version: Version) -> Result<Transaction> {
        self.db
            ...
            .ok_or_else(|| NabobDbError::NotFound(format!("Txn {version}")))
    }
