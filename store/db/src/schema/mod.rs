...
//! This module defines representation of Nabob core data structures at physical level via schemas
//! that implement [`nabob_schemadb::schema::Schema`].
//!
...
use nabob_schemadb::ColumnFamilyName;
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use nabob_schemadb::schema::fuzzing::assert_no_panic_decoding;
