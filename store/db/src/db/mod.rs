...
use nabob_db_indexer::{db_indexer::InternalIndexerDB, Indexer};
use nabob_runtimes_extension::thread_manager::THREAD_MANAGER;
...
use nabob_storage_interface::{
    db_ensure as ensure, db_other_bail as bail, NabobDbError, DbReader, DbWriter, LedgerSummary,
...
/// access to the core Nabob data structures.
pub struct NabobDB {
...
include!("include/nabobdb_reader.rs");
// DbWriter implementations and private functions used by them.
include!("include/nabobdb_writer.rs");
// Other private methods.
include!("include/nabobdb_internal.rs");
// Testonly methods.
#[cfg(any(test, feature = "fuzzing", feature = "consensus-only-perf-test"))]
include!("include/nabobdb_testonly.rs");

#[cfg(feature = "consensus-only-perf-test")]
pub mod fake_nabobdb;
...
impl NabobDB {
    ...
    pub fn create_checkpoint(
        ...
        info!(sharding = sharding, "Creating checkpoint for NabobDB.");
