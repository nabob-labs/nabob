...
impl From<nabob_vault_cli::Error> for Error {
    fn from(error: nabob_vault_cli::Error) -> Self {
        match error {
            nabob_vault_cli::Error::NotFound(_, key) => Self::KeyNotSet(key),
            nabob_vault_cli::Error::HttpError(403, _, _) => Self::PermissionDenied,
