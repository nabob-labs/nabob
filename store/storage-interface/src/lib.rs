...
pub use nabob_types::block_info::BlockHeight;
use nabob_types::state_store::state_key::prefix::StateKeyPrefix;
pub use errors::NabobDbError;
pub use ledger_summary::LedgerSummary;

pub type Result<T, E = NabobDbError> = std::result::Result<T, E>;
...
impl From<nabob_secure_net::Error> for Error {
    fn from(error: nabob_secure_net::Error) -> Self {
        Self::ServiceError {
            error: format!("{}", error),
        }
    }
...
pub trait DbReader: Send + Sync {
    ...
    delegate_read!(
        /// See [NabobDB::get_epoch_ending_ledger_infos].
        ///
        /// [NabobDB::get_epoch_ending_ledger_infos]:
        /// ../nabobdb/struct.NabobDB.html#method.get_epoch_ending_ledger_infos
        ...
        /// See [NabobDB::get_transactions].
        ///
        /// [NabobDB::get_transactions]: ../nabobdb/struct.NabobDB.html#method.get_transactions
        fn get_transactions(
            &self,
        ...
        /// See [NabobDB::get_transaction_by_hash].
        ///
        /// [NabobDB::get_transaction_by_hash]: ../nabobdb/struct.NabobDB.html#method.get_transaction_by_hash
        ...
        /// See [NabobDB::get_transaction_by_version].
        ///
        /// [NabobDB::get_transaction_by_version]: ../nabobdb/struct.NabobDB.html#method.get_transaction_by_version
        ...
        /// See [NabobDB::get_first_txn_version].
        ///
        /// [NabobDB::get_first_txn_version]: ../nabobdb/struct.NabobDB.html#method.get_first_txn_version
        fn get_first_txn_version(&self) -> Result<Option<Version>>;

        /// See [NabobDB::get_first_viable_block].
        ///
        /// [NabobDB::get_first_viable_block]: ../nabobdb/struct.NabobDB.html#method.get_first_viable_block
        fn get_first_viable_block(&self) -> Result<(Version, BlockHeight)>;

        /// See [NabobDB::get_first_write_set_version].
        ///
        /// [NabobDB::get_first_write_set_version]: ../nabobdb/struct.NabobDB.html#method.get_first_write_set_version
        fn get_first_write_set_version(&self) -> Result<Option<Version>>;

        /// See [NabobDB::get_transaction_outputs].
        ///
        /// [NabobDB::get_transaction_outputs]: ../nabobdb/struct.NabobDB.html#method.get_transaction_outputs
        ...
        /// See [NabobDB::get_block_timestamp].
        ///
        /// [NabobDB::get_block_timestamp]:
        /// ../nabobdb/struct.NabobDB.html#method.get_block_timestamp
        fn get_block_timestamp(&self, version: Version) -> Result<u64>;

        /// See `NabobDB::get_latest_block_events`.
        ...
        /// See [NabobDB::get_state_value_by_version].
        ///
        /// [NabobDB::get_state_value_by_version]:
        /// ../nabobdb/struct.NabobDB.html#method.get_state_value_by_version
        ...
        /// See [NabobDB::get_state_value_with_version_by_version].
        ///
        /// [NabobDB::get_state_value_with_version_by_version]:
        /// ../nabobdb/struct.NabobDB.html#method.get_state_value_with_version_by_version
        ...
        /// See [NabobDB::get_account_state_with_proof_by_version].
        ///
        /// [NabobDB::get_account_state_with_proof_by_version]:
        /// ../nabobdb/struct.NabobDB.html#method.get_account_state_with_proof_by_version
        ///
        /// This is used by nabob core (executor) internally.
    ...
    fn get_latest_ledger_info(&self) -> Result<LedgerInfoWithSignatures> {
        self.get_latest_ledger_info_option().and_then(|opt| {
            opt.ok_or_else(|| NabobDbError::Other("Latest LedgerInfo not found.".to_string()))
        })
    }
    ...
    fn ensure_synced_version(&self) -> Result<Version> {
        self.get_synced_version()?
            .ok_or_else(|| NabobDbError::NotFound("Synced version not found.".to_string()))
    }
    ...
    fn ensure_pre_committed_version(&self) -> Result<Version> {
        self.get_pre_committed_version()?
            .ok_or_else(|| NabobDbError::NotFound("Pre-committed version not found.".to_string()))
    }
}

/// Trait that is implemented by a DB that supports certain public (to client) write APIs
/// expected of an Nabob DB. This adds write APIs to DbReader.
#[allow(unused_variables)]
...
macro_rules! db_not_found_bail {
    ($($arg:tt)*) => {
        return Err(NabobDbError::NotFound(format!($($arg)*)))
    };
}
...
macro_rules! db_other_bail {
    ($($arg:tt)*) => {
        return Err(NabobDbError::Other(format!($($arg)*)))
    };
}
