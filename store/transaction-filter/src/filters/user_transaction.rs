...
/// Example:
/// ```
/// use nabob_transaction_filter::UserTransactionFilterBuilder;
///
...
impl From<nabob_protos::indexer::v1::UserTransactionFilter> for UserTransactionFilter {
    fn from(proto_filter: nabob_protos::indexer::v1::UserTransactionFilter) -> Self {
        Self {
...
impl From<UserTransactionFilter> for nabob_protos::indexer::v1::UserTransactionFilter {
...
/// Example:
/// ```
/// use nabob_transaction_filter::EntryFunctionFilterBuilder;
///
...
impl From<nabob_protos::indexer::v1::EntryFunctionFilter> for EntryFunctionFilter {
    fn from(proto_filter: nabob_protos::indexer::v1::EntryFunctionFilter) -> Self {
        Self {
...
impl From<EntryFunctionFilter> for nabob_protos::indexer::v1::EntryFunctionFilter {
...
/// Example:
/// ```
/// use nabob_transaction_filter::{EntryFunctionFilterBuilder, UserTransactionPayloadFilterBuilder};
///
...
impl From<nabob_protos::indexer::v1::UserTransactionPayloadFilter>
    for UserTransactionPayloadFilter
{
    fn from(proto_filter: nabob_protos::indexer::v1::UserTransactionPayloadFilter) -> Self {
        Self {
...
impl From<UserTransactionPayloadFilter>
    for nabob_protos::indexer::v1::UserTransactionPayloadFilter
{
