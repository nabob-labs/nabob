...
use anyhow::Error;
use nabob_protos::transaction::v1::{move_type::Content, Event};
...
/// Example:
/// ```
/// use nabob_transaction_filter::{EventFilterBuilder, MoveStructTagFilterBuilder};
///
...
impl From<nabob_protos::indexer::v1::EventFilter> for EventFilter {
    fn from(proto_filter: nabob_protos::indexer::v1::EventFilter) -> Self {
        Self {
...
impl From<EventFilter> for nabob_protos::indexer::v1::EventFilter {
