...
use anyhow::Error;
use nabob_protos::transaction::v1::{transaction::TransactionType, Transaction};
use serde::{Deserialize, Serialize};

/// Example:
/// ```
/// use nabob_transaction_filter::TransactionRootFilterBuilder;
///
...
impl From<nabob_protos::indexer::v1::TransactionRootFilter> for TransactionRootFilter {
    fn from(proto_filter: nabob_protos::indexer::v1::TransactionRootFilter) -> Self {
        Self {
...
impl From<TransactionRootFilter> for nabob_protos::indexer::v1::TransactionRootFilter {
