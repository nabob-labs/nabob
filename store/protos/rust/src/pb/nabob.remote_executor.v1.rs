...
/// Encoded file descriptor set for the `nabob.remote_executor.v1` package
...
include!("nabob.remote_executor.v1.serde.rs");
include!("nabob.remote_executor.v1.tonic.rs");
