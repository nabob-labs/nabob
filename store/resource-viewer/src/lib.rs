...
use nabob_types::state_store::StateView;
use nabob_vm::data_cache::get_resource_group_member_from_metadata;
...
pub struct NabobValueAnnotator<'a, S>(MoveValueAnnotator<ModuleView<'a, S>>);

impl<'a, S: StateView> NabobValueAnnotator<'a, S> {
