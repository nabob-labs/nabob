...
pub fn convert_event(event: &Event) -> transaction::Event {
    let event_key: nabob_types::event::EventKey = event.guid.into();
    transaction::Event {
...
fn convert_validator_transaction(
    api_validator_txn: &nabob_api_types::transaction::ValidatorTransaction,
                        ...
                        validator_transaction::ObservedJwkUpdate {
                            quorum_certified_update: Some(
                                validator_transaction::observed_jwk_update::QuorumCertifiedUpdate {
                                    ...
                                    multi_sig: Some(nabob_protos::transaction::v1::validator_transaction::observed_jwk_update::ExportedAggregateSignature {
