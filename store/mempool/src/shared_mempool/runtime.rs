...
use nabob_config::config::{NodeConfig, NodeType};
...
use nabob_types::on_chain_config::OnChainConfigProvider;
use nabob_vm_validator::vm_validator::{PooledVMValidator, TransactionValidation};
    ...
    ConfigProvider: OnChainConfigProvider,
{
    ...
    if nabob_logger::enabled!(Level::Trace) {
