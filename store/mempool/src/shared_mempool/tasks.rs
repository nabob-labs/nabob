...
use nabob_consensus_types::common::RejectedTransactionSummary;
use nabob_crypto::HashValue;
use nabob_infallible::{Mutex, RwLock};
use nabob_logger::prelude::*;
use nabob_mempool_notify::CommittedTransaction;
use nabob_metrics_core::HistogramTimer;
use nabob_network::application::interface::NetworkClientInterface;
use nabob_storage_interface::state_store::state_view::db_state_view::LatestDbStateCheckpointView;
use nabob_types::{
...
use nabob_vm_validator::vm_validator::{get_account_sequence_number, TransactionValidation};
        ...
        QuorumStoreRequest::GetBatchRequest(
            ...
            let txns;
            {
...

                {
                    ...
                    let curr_time = nabob_infallible::duration_since_epoch();
