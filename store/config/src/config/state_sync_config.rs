...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct NabobDataPollerConfig {
...
impl Default for NabobDataPollerConfig {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct NabobDataMultiFetchConfig {
...
impl Default for NabobDataMultiFetchConfig {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct NabobLatencyFilteringConfig {
...
impl Default for NabobLatencyFilteringConfig {
    fn default() -> Self {
        Self {
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq, Serialize)]
#[serde(default, deny_unknown_fields)]
pub struct NabobDataClientConfig {
    /// The nabob data poller config for the data client
    pub data_poller_config: NabobDataPollerConfig,
    /// The nabob data multi-fetch config for the data client
    pub data_multi_fetch_config: NabobDataMultiFetchConfig,
    /// Whether or not to ignore peers with low peer scores
    pub ignore_low_score_peers: bool,
    /// The nabob latency filtering config for the data client
    pub latency_filtering_config: NabobLatencyFilteringConfig,
...
impl Default for NabobDataClientConfig {
    fn default() -> Self {
        Self {
            data_poller_config: NabobDataPollerConfig::default(),
            data_multi_fetch_config: NabobDataMultiFetchConfig::default(),
            ignore_low_score_peers: true,
            latency_filtering_config: NabobLatencyFilteringConfig::default(),
