...
/// Port selected RocksDB options for tuning underlying rocksdb instance of NabobDB.
...
pub struct StorageConfig {
    ...
    #[serde(skip)]
    data_dir: PathBuf,
    /// NabobDB persists the state authentication structure off the critical path
