...
use nabob_resource_viewer::{AnnotatedMoveStruct, AnnotatedMoveValue};
use nabob_types::{account_config::CORE_CODE_ADDRESS, event::EventKey, transaction::Module};
...
mod tests {
    ...
    fn test_parse_invalid_move_module_id_string() {
        ...
        assert_eq!(
            "Invalid Move module ID: Nabob::Nabob",
            "Nabob::Nabob"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid Move module ID: 0x1::Nabob::Nabob",
            "0x1::Nabob::Nabob"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
    ...
    fn test_parse_invalid_move_entry_function_id_string() {
        ...
        assert_eq!(
            "Invalid entry function ID Nabob::Nabob",
            "Nabob::Nabob"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid entry function ID 0x1::Nabob::Nabob::Nabob",
            "0x1::Nabob::Nabob::Nabob"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
                .to_string()
