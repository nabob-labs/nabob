...
use anyhow::ensure;
use nabob_crypto::{bls12381, CryptoMaterialError};
...
/// on the equivalent of a NabobBFT v4 timeout message.
...
/// have voted in round r and we can now move to round r+1. NabobBFT v4 requires signature to sign on
