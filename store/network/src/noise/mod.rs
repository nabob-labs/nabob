...
//! We use Noise to secure connections between peers in Nabob.
...
//!
//! ```
//! use nabob_network::noise::{AntiReplayTimestamps, HandshakeAuthMode, NoiseUpgrader};
//! use futures::{executor, future, io::{AsyncReadExt, AsyncWriteExt}};
//! use nabob_memsocket::MemorySocket;
//! use nabob_config::{config::{Peer, PeerRole}, network_id::{NetworkContext, NetworkId}};
//! use nabob_crypto::{x25519, ed25519, Uniform, PrivateKey, test_utils::TEST_SEED};
//! use nabob_infallible::RwLock;
//! use rand::{rngs::StdRng, SeedableRng};
//! use nabob_types::PeerId;
//! use std::{collections::{HashSet, HashMap}, io, sync::Arc};
//! use nabob_config::config::RoleType;
...
//! [crypto]: ../nabob_crypto/noise/index.html
