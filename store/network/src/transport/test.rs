...
use nabob_config::config::{Peer, PeerRole, PeerSet, HANDSHAKE_VERSION};
use nabob_crypto::{test_utils::TEST_SEED, traits::Uniform, x25519, x25519::PrivateKey};
use nabob_netcore::{
...
fn setup<TTransport>(
    ...
    Runtime,
    MockTimeService,
    (PeerId, NabobNetTransport<TTransport>),
    (PeerId, NabobNetTransport<TTransport>),
    ...
    TTransport::Listener: Send + 'static,
{
    ...
    let listener_transport = NabobNetTransport::new(
    ...
    let dialer_transport = NabobNetTransport::new(
        base_transport,
        dialer_network_context,
        time_service.clone(),
        dialer_key,
...
////////////////////////////////////////
// NabobNetTransport<MemoryTransport> //
////////////////////////////////////////
...
/////////////////////////////////////
// NabobNetTransport<TcpTransport> //
/////////////////////////////////////

#[test]
fn test_tcp_transport_mutual_auth() {
    test_transport_success(
        NABOB_TCP_TRANSPORT.clone(),
        Auth::Mutual,
        "/ip4/127.0.0.1/tcp/0",
