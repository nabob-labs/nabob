...
use nabob_num_variants::NumVariants;
use nabob_short_hex_str::AsShortHexStr;
use nabob_time_svc::{TimeService, TimeServiceTrait};
use nabob_types::{account_address::AccountAddress, network_address::NetworkAddress, PeerId};
use futures::{
    channel::oneshot,
...
pub struct ConnectivityManager<TBackoff> {
    ...
    requests_rx: nabob_channels::Receiver<ConnectivityRequest>,
