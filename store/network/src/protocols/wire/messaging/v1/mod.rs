...
//! This module defines the NabobNet v1 message types, how they are
...
//!
//! The [NabobNet Specification](https://github.com/nabob-labs/nabob/blob/main/documentation/specifications/network/messaging-v1.md)
