...
//! Implementation of the unary RPC protocol as per [NabobNet wire protocol v1].
//!
//! ## Design:
//!
...
//!
//! [NabobNet wire protocol v1]: https://github.com/nabob-labs/nabob/blob/main/specifications/network/messaging-v1.md
...
impl InboundRpcs {
    ...
    pub fn handle_inbound_request(
        &mut self,
        peer_notifs_tx: &nabob_channel::Sender<(PeerId, ProtocolId), ReceivedMessage>,
