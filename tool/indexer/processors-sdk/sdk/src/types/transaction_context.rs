...
use nabob_indexer_transaction_stream::utils::timestamp_to_unixtime;
...
pub struct TransactionMetadata {
    ...
    pub end_version: u64,
    pub start_transaction_timestamp: Option<nabob_protos::util::timestamp::Timestamp>,
    pub end_transaction_timestamp: Option<nabob_protos::util::timestamp::Timestamp>,
