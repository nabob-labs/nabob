...
use nabob_protos::transaction::v1::Transaction as ProtoTransaction;
...
pub struct DefaultProcessingResult {
    ...
    pub end_version: u64,
    pub last_transaction_timestamp: Option<nabob_protos::util::timestamp::Timestamp>,
...
pub trait ProcessorTrait: Send + Sync + Debug {
    ...
    async fn update_last_processed_version(
        &self,
        version: u64,
        last_transaction_timestamp: Option<nabob_protos::util::timestamp::Timestamp>,
    ) -> anyhow::Result<()> {
