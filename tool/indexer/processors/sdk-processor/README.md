# Nabob Core Processors (SDK version)
Processors that index data from the Nabob Transaction Stream (GRPC). These processors have been (re)-written using the new Indexer SDK.

- **Note: Official releases coming soon!**

## Overview
This tutorial shows you how to run the Nabob core processors in this repo.

If you want to index a custom contract, we recommend using the [Quickstart Guide](https://nabob.dev/en/build/indexer/indexer-sdk/quickstart).
...
- A `config.yaml` file
    ...
    server_config:
        ...
        transaction_stream_config:
            indexer_grpc_data_service_address: "https://grpc.mainnet.naboblabs.com:443"
            starting_version: 0
...
- `processor_config`
    ...
    - Individual processors may have different configuration required. See the full list of configs [here](https://github.com/nabob-labs/nabob-indexer-processors/blob/main/rust/sdk-processor/src/config/processor_config.rs#L89).
- `transaction_stream_config`
...
See mapping in [v2_fungible_asset_balances.rs](https://github.com/nabob-labs/nabob-indexer-processors/blob/main/rust/processor/src/db/common/models/fungible_asset_models/v2_fungible_asset_balances.rs#L40) for a list supported coin type mappings.