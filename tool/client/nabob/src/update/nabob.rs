...
impl BinaryUpdater for NabobUpdateTool {
    fn check(&self) -> bool {
        self.check
    }
    ...
    fn get_update_info(&self) -> Result<UpdateRequiredInfo> {
        ...
        // this will fail. See https://github.com/nabob-labs/nabob/issues/6411.
        ...
        let latest_release = loop {
            ...
            if release.version.starts_with("nabob-cli-") {
                break release;
            }
        };
    ...
    fn build_updater(&self, info: &UpdateRequiredInfo) -> Result<Box<dyn ReleaseUpdate>> {
        ...
        match installation_method {
            ...
            InstallationMethod::Homebrew => {
                return Err(anyhow!(
                    "Detected this CLI comes from homebrew, use `brew upgrade nabob` instead"
                ));
            },
        ...
        Update::configure()
            ...
            .target_version_tag(&format!("nabob-cli-v{}", info.target_version))
            .target(target)
            .build()
...
#[async_trait]
impl CliCommand<String> for NabobUpdateTool {
