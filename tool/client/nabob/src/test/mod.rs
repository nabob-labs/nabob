...
use nabob_genesis::config::HostAndPort;
use nabob_keygen::KeyGen;
use nabob_logger::warn;
use nabob_rest_cli::{
    nabob_api_types::{MoveStructTag, MoveType},
    Transaction,
};
use nabob_sdk::move_types::{account_address::AccountAddress, language_storage::ModuleId};
use nabob_temppath::TempPath;
use nabob_types::on_chain_config::ValidatorSet;
...
impl CliTestFramework {
    ...
    async fn check_account_exists(&self, index: usize) -> bool {
        ...
        let client = nabob_rest_cli::Client::new(self.endpoint.clone());
            ...
            entry_function_args: EntryFunctionArguments {
                ...
                type_arg_vec: TypeArgVec {
                    type_args: vec![MoveType::Struct(MoveStructTag::new(
                        ...
                        ident_str!("nabob_coin").into(),
                        ident_str!("NabobCoin").into(),
                        vec![],
                    ))],
                },
                json_file: None,
    ...
    async fn last_n_transactions_details(&self, count: u16) -> String {
        let result = nabob_rest_cli::Client::new(self.endpoint.clone())
    ...
    pub fn add_move_files(&self) {
        ...
        let hello_blockchain_test_contents = include_str!("../../../../../mos/move-examples/hello_blockchain/sources/hello_blockchain_test.move");
    ...
    /// Runs the given script contents using the local nabob_framework directory.
    pub async fn run_script(
        ...
        self.run_script_with_framework_package(index, script_contents, FrameworkPackageArgs {
            framework_git_rev: None,
            framework_local_dir: Some(Self::nabob_framework_dir()),
            skip_fetch_latest_git_deps: false,
        })
        .await
    }
    ...
    /// Runs the given script contents using the nabob_framework from nabob git repository.
    ...
    pub fn nabob_framework_dir() -> PathBuf {
