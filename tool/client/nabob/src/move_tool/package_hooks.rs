...
use nabob_framework::UPGRADE_POLICY_CUSTOM_FIELD;
...
pub fn register_package_hooks() {
    move_package::package_hooks::register_package_hooks(Box::new(NabobPackageHooks {}))
}

struct NabobPackageHooks {}

impl PackageHooks for NabobPackageHooks {
    fn custom_package_info_fields(&self) -> Vec<String> {
        vec![UPGRADE_POLICY_CUSTOM_FIELD.to_string()]
    }

    fn custom_dependency_key(&self) -> Option<String> {
        Some("nabob".to_string())
    }
