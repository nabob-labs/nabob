...
/// Command Line Interface (CLI) for developing and interacting with the Nabob blockchain
#[derive(Parser)]
#[clap(name = "nabob", author, version, propagate_version = true, styles = nabob_cli_common::nabob_cli_style())]
pub enum Tool {
    #[clap(subcommand)]
