...
use anyhow::Result;
use nabob_framework::natives::code::PackageMetadata;
use nabob_types::{
...
pub trait NabobValidatorInterface: Sync {
...
async fn handler_thread<'a>(
    db: Arc<dyn NabobValidatorInterface + Send>,
...
impl DebuggerStateView {
    pub fn new(db: Arc<dyn NabobValidatorInterface + Send>, version: Version) -> Self {
