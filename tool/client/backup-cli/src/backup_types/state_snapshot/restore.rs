...
use nabob_db::state_restore::StateSnapshotRestoreMode;
use nabob_infallible::Mutex;
use nabob_logger::prelude::*;
use nabob_storage_interface::StateSnapshotReceiver;
use nabob_types::{
    access_path::Path,
...
use nabob_vm_environment::prod_configs::nabob_prod_verifier_config;
use clap::Parser;
...
impl StateSnapshotRestoreController {
    ...
    fn validate_modules(blob: &[(StateKey, StateValue)]) {
        ...
        let config = nabob_prod_verifier_config(&features);
