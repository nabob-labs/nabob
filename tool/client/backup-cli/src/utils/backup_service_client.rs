...
use nabob_db::backup::backup_handler::DbState;
use nabob_metrics_core::{IntCounterHelper, TimerHelper};
...
pub struct BackupServiceClientOpt {
    #[clap(
        ...
        help = "Backup service address. By default a Nabob Node runs the backup service serving \
