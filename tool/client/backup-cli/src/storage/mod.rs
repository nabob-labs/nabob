...
pub enum StorageOpt {
    ...
    https://github.com/nabob-labs/nabob/tree/main/storage/backup/backup-cli/src/storage/command_adapter/sample_configs/"
    )]
...
pub struct DBToolStorageOpt {
    ...
    it communicates with either a local file system or a remote cloud storage. Compression or other \
    filters can be added as part of the commands. See a sample config here: \
    https://github.com/nabob-labs/nabob-networks/tree/main/testnet/backups "
    )]
